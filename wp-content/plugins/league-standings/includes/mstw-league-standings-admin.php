...
*/	
	...
	function mstw_ls_restrict_manage_posts( ) {
		...
		if ( $typenow=='league_team' ){
			...
			foreach ( $taxonomy_slugs as $tax_slug ) {
				...
				echo "<option value=''>". __( 'Show All Leagues', 'league-standings') . "</option>";
	...
	} //End: mstw_ls_restrict_manage_posts( )
	...
	function mstw_ls_create_ui( $team ) {
	   ...
	   <table class="form-table">
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_rank" ><?php _e( 'Rank (or Place):', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_rank"
				value="<?php echo esc_attr( $rank ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_name" ><?php _e( 'Team Name:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_name"
				value="<?php echo esc_attr( $name ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_team_link" ><?php _e( 'Team Link:', 'league-standings' ); ?></label></th>
			<td><input maxlength="128" size="20" name="mstw_ls_team_link"
				value="<?php echo esc_url( $team_link ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_mascot" ><?php _e( 'Team Mascot:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_mascot"
				value="<?php echo esc_attr( $mascot ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_games_played" ><?php _e( 'Games Played:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_games_played"
				value="<?php echo esc_attr( $games_played ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_wins" ><?php _e( 'Wins:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_wins"
				value="<?php echo esc_attr( $wins ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_losses" ><?php _e( 'Losses:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_losses"
				value="<?php echo esc_attr( $losses ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_ties" ><?php _e( 'Ties:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_ties"
				value="<?php echo esc_attr( $ties ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_other" ><?php _e( 'Other:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_other"
				value="<?php echo esc_attr( $other ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_percent" ><?php _e( 'Win Percentage (INFO ONLY):', 'league-standings' ); ?></label></th>
			<td><?php echo esc_attr( $percent )?></td>
			<td><?php _e( 'Win percentage is calculated from Wins, Losses and Ties. See documentation for formula and how to modify it.', 'league-standings' ); ?></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_points" ><?php _e( 'Points:', 'league-standings' ); ?> </label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_points"
				value="<?php echo esc_attr( $points ); ?>"/></td>
			<td><?php _e( 'Points are calculated differently in different leagues, so right now you have to enter them. [This could change in a future release.]', 'league-standings' ); ?></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_games_behind" ><?php _e( 'Games Behind:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_games_behind"
				value="<?php echo esc_attr( $games_behind ); ?>"/></td>
				<td><?php _e( 'Right now you have to enter Games Behind if you want it. It will be calculated for you in a future release.', 'league-standings' ); ?></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_goals_for" ><?php _e( 'Goals For:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_goals_for"
				value="<?php echo esc_attr( $goals_for ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_goals_against" ><?php _e( 'Goals Against:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_goals_against"
				value="<?php echo esc_attr( $goals_against ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_last_5" ><?php _e( 'Record in Last 5 Games:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_last_5"
				value="<?php echo esc_attr( $last_5 ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_last_5" ><?php _e( 'Record in Last 10 Games:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_last_10"
				value="<?php echo esc_attr( $last_10 ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_streak" ><?php _e( 'Current Streak:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_streak"
				value="<?php echo esc_attr( $streak ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_home" ><?php _e( 'Home Record:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_home"
				value="<?php echo esc_attr( $home ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_away" ><?php _e( 'Road Record:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_away"
				value="<?php echo esc_attr( $away ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_division" ><?php _e( 'Record in Division:', 'league-standings' ); ?></label></th>
			<td><input maxlength="32" size="20" name="mstw_ls_division"
				value="<?php echo esc_attr( $division ); ?>"/></td>
		</tr>
		
		<tr valign="top">
			<th scope="row"><label for="mstw_ls_conference" ><?php _e( 'Record in Conference:', 'league-standings' ); ?></label></th>
	...
	function mstw_ls_edit_columns( $columns ) {	
		...
		$columns = array(
			...
			'title' => __( 'Title', 'league-standings' ),
			'league' => __( 'League', 'league-standings' ),
			'name' => __( 'Name', 'league-standings' ),
			'mascot' => __( 'Mascot', 'league-standings' ),
			'rank' => __( 'Rank', 'league-standings' ),
			'games_played' => __( 'GP', 'league-standings' ),
			'wins' => __( 'W', 'league-standings' ),
			'losses' => __( 'L', 'league-standings' ),
			'ties' => __( 'T', 'league-standings' ),
			//'other' => __( 'Other', 'league-standings' ),
			//'goals_for' => __( 'Goals For', 'league-standings' ),
			//'goals_against' => __( 'Goals Against', 'league-standings' ),
			//'last_5' => __( 'Last 5', 'league-standings' ),
			//'last_10' => __( 'Last 10', 'league-standings' ),
	...
	function mstw_ls_option_page() {
		...
		<div class="wrap">
			...
			<form action="options.php" method="post">
				...
				<p>
				<input name="Submit" type="submit" class="button-primary" value=<?php _e( "Save Changes", "league-standings" ); ?>  />
				
				<input type="submit" name="mstw_ls_options[reset]" value="Reset Default Values" />
				<strong><?php _e( "WARNING! Reset Default Values will do so without further warning!", "league-standings" ); ?></strong>
				</p>
			</form>
		</div>
		<?php
...
// ----------------------------------------------------------------	
	function mstw_ls_main_inst( ) {
		echo '<p>' . __( 'Display settings to control your DEFAULT standings tables. ', 'league-standings' ) .'<br/>' .  __( 'You can override these defaults with arguments in your shortcodes. ' ) . '</p>';
		/* Just in case we add some colors someday
		'<br/>' . __( 'All color values are in hex, starting with a hash(#), followed by either 3 or 6 hex digits. For example, #123abd or #1a2.', 'league-standings' ) .  '</p>';
		*/
	}
...
// ----------------------------------------------------------------	
	...
	function mstw_ls_date_time_inst( ) {
		echo '<p>' . __( 'Enter the date-time formats for your shortcodes and widgets. ', 'league-standings' ) . '</p>';
	}
