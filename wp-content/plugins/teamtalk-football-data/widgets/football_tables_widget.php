...
class football_tables_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
                'football_tables_widget',
                'Football Tables Widget', array('description' => 'Football: Football Tables Widget')
        );
    }
...
add_action('widgets_init', function() {
    register_widget('football_tables_widget');
});
?>
