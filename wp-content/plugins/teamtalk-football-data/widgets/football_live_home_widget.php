...
class football_live_home_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
                'football_live_home_widget', // Base ID
...
<!--                --><?php //$competition_selected = array($competition_id); ?>
<!--                --><?php //if (!in_array($key , $competition_selected)): ?>
<!--                    --><?php //$fixtures_handle[$key] = $fixture; ?>
<!--                --><?php //endif ?>
<!--        --><?php //endforeach; ?>

        <!-- Football - Live Scores Home -->
        <div class="article football-fixtures-results football-live-scoring cricket-live-home">
            <header class="articleList__header">
                <h3>Live Scores</h3>
            </header>
            <div class="row live-scoring-header">
                <div class="col-md-6 col-xs-6 live-date">
                    <i class="fa fa-calendar" aria-hidden="true"></i> <span>Friday 10 June 2016</span>
                </div>
                <div class="col-md-6 col-xs-6 filter-tournament">
...
add_action('widgets_init', function() {
    register_widget('football_live_home_widget');
});
?>
