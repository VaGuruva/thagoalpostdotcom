...
class football_results_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'football_results_widget', // Base ID
            '[Comp] Results Widget', // Name
            array('description' => 'This is the Competition Results Widget',) // Args
        );
    }
                        ...
                        <?php foreach ($fixtures as $fixture): ?>
                            ...
                            <tr>
                                ...
                                <td class="score"><span><?php echo $result->home_final_score ?></span><span>-</span><span><?php echo $result->away_final_score ?></span>
                                    ...
                                    <span class="match-page"><a href="<?php echo site_url() ?>/match/<?php echo $match ?>/<?php echo $result->match_id ?>">Match Page ></a></span></td>
...
add_action('widgets_init', function () {
    register_widget('football_results_widget');
});
?>