...
class football_tables_fixtures_results_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
            'football_tables_fixtures_results_widget', // Base ID
...
add_action('widgets_init', function () {
    register_widget('football_tables_fixtures_results_widget');
});
?>