        ...
        public function fake_wp_footer() {
            ...
            if (is_front_page() || is_single() || is_page() || is_category() || is_tag() || is_archive()) {
                ...
                if (ms_Main::$settings['ms_author_linking'] == '1') {
                    echo '<div style="z-index:999999;text-align:center;font-size:12px;">Powered by <a href="https://www.macsonuclarim.com">Maç Sonuçları</a> & <a href="https://itunes.apple.com/tr/app/mac-sonuclar-m/id1084521855">Canlı Skor Mobil</a></div>' . "\n";
                }
            }
        }
    } // end ms_Show
